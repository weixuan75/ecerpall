        ...
        <div class="ibox-content">
            <form class="form-horizontal m-t" id="product_category_form" name="product_category_form" method="post" action="/index.php?r=product/product-category/create">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="name" name="name" placeholder="产品类型名称"/>
                    </div>
                </div>
                <div class="form-group">
...
<script>
    function submit_form(){
        var form_data = $("#product_category_form").serializeJSON();
        form_data._csrf = "<?= Yii::$app->request->csrfToken ?>";
        $.ajax({
            //cache: true,
            type: "post",
            //sss: $("#product_form").serialize(),
            url: "index.php?r=product/product-category/create",
