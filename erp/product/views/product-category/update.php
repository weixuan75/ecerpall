...
<div class="wrapper wrapper-content  animated fadeInRight">
    <div class="ibox-content">
        <form class="form-horizontal m-t" id="product_category_form" name="product_category_form" method="post" action="/index.php?r=product/product-category/create">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="name" name="name" placeholder="产品类型名称" value="<?=$model->name ?>"/>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-4 col-sm-offset-3">
                    <button class="btn btn-primary" type="button" onclick="submit_form()">修改产品类型</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    function submit_form(){
        $.ajax({
            ...
            url: "index.php?r=product/product-category/update",
