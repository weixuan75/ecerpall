    ...
    <div class="ibox-content">
        <form class="form-horizontal m-t" id="product_category_form" name="product_category_form" method="post" action="/index.php?r=product/product-brand/create">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="name" name="name" placeholder="产品品牌名称" value="<?=$model->name ?>"/>
                </div>
            </div>
            <div class="form-group">
...
<script>
    function submit_form(){
        $.ajax({
            ...
            url: "index.php?r=product/product-brand/update",
            ...
            success: function (data) {
                ...
                layer.msg(d.msg, {icon:d.code, time:1500, shade:0.1});
            }
        });
    }
</script>
