    ...
    <div class="header-right pull-right">
        <div class="search">
            <form action="">
                ...
                <input type="submit" class="submit" name="sbumit">
            </form>
        </div>
        <div class="top-nav">
            <ul>
                <li><a href=""><i class="fa fa-bell"></i><span>通知公告</span></a></li>
                <li><a href=""><i class="fa fa-question-circle"></i><span>使用指南</span></a></li>
                <li><a class="J_menuItem" href="/admin/usert/chmodinfo"><i class="fa fa-pencil"></i><span>修改信息</span></a></li>
                <li><a href="{:url('admin/login/loginOut')}"><i class="fa fa-remove"></i><span>退出</span></a></li>
            </ul>
        </div>
    </div>
</div>
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            <button class="roll-nav roll-left J_tabLeft" onclick="toMiniBar(this)" ><i class="fa fa-backward"></i>
            </button>
...
<script type="text/javascript">
    ...
    function toMiniBar(obj){
        if($("body").hasClass("mini-navbar"))
        {
            $("body").removeClass("mini-navbar");
            $(obj).find("i").removeClass("fa-forward");
            $(obj).find("i").addClass("fa-backward");
        }
        else
        {
            $("body").addClass("mini-navbar");
            $(obj).find("i").removeClass("fa-backward");
            $(obj).find("i").addClass("fa-forward");
        }
    }
